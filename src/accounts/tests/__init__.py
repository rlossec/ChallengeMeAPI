...
FIELD_TOO_LONG_ERROR_MESSAGE = 'Ensure this field has no more than 150 characters.'
# ID
NOT_FOUND_ID = 9999
# User ID
...
USERNAME_INVALID_CHARACTERS_ERROR_MESSAGE = 'Enter a valid username. This value may contain only letters, numbers, and @/./+/-/_ characters.'
# Email
...
# Password
PASSWORD_MISMATCH_ERROR_MESSAGE = 'The two password fields didn\'t match.'
